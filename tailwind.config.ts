...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Brand colors - Purple to Pink gradient theme
        primary: {
          50: '#faf5ff',
          100: '#f3e8ff',
          200: '#e9d5ff',
      ...
      backgroundImage: {
        ...
        'gradient-hero': 'linear-gradient(135deg, #9333ea 0%, #ec4899 50%, #3b82f6 100%)',
      ...
      boxShadow: {
        ...
        'purple': '0 10px 40px -10px rgba(147, 51, 234, 0.4)',
