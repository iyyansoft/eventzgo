...
export default function AdminManagementError({ error, reset }: { error: Error; reset?: () => void }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
      <div className="max-w-xl w-full bg-white rounded-2xl shadow-lg p-8 text-center">
        ...
        <p className="text-sm text-gray-600 mb-6">An unexpected error occurred in the admin management area.</p>
