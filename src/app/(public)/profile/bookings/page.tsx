...
import { Calendar, MapPin, Ticket, Loader2, ChevronRight, Download } from "lucide-react";
...
export default function MyBookingsPage() {
  ...
  const handleDownloadPDF = async (booking: any, e: React.MouseEvent) => {
    e.stopPropagation();
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                          ...
                          <div className="flex items-center space-x-3">
                            <button
                              ...
                              className="flex items-center space-x-2 px-4 py-2 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
