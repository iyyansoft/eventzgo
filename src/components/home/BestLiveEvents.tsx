...
export default function BestLiveEvents() {
    const router = useRouter();
    const events = useQuery(api.events.getAllEvents, { category: "concerts", status: "approved", limit: 4 }) || [];
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {liveEvents && liveEvents.length > 0 ? (
                        ...
                        <div className="col-span-full text-center py-12">
                            <p className="text-gray-500 text-lg">No live events available at the moment</p>
                        </div>
                    )}
                </div>
            </div>
