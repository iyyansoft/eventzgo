// src/components/management/AdminSidebar.tsx - NEW FILE (Admin only)
'use client';
...
export default function AdminSidebar() {
    ...
    const menuItems = [
        ...
        },
        {
            icon: UserCheck,
            label: 'Organisers',
            path: '/management/admin/organisers',
        },
        {
            icon: Calendar,
            label: 'Events',
            path: '/management/admin/events',
        },
        {
            icon: Users,
            label: 'Users',
        ...
        },
        {
            icon: BarChart3,
            label: 'Analytics',
            path: '/management/admin/analytics',
        },
    ];
    ...
    return (
        <div className="w-64 bg-white border-r border-gray-200 h-screen flex flex-col">
            ...
            <div className="p-4 border-t border-gray-200 space-y-2">
                <button
                    onClick={() => router.push('/management/admin/settings')}
                ...
                <button
                    onClick={() => router.push('/management/admin/help')}
                    className="w-full flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-gray-100 rounded-xl transition-all duration-200"
                >
